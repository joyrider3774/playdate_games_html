...
var ASM_CONSTS = {
 ...
 655292: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 655375: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 655444: () => { return window.innerWidth; },  
 655474: () => { return window.innerHeight; }
};
