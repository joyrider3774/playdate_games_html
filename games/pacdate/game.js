...
Module['FS_createPath']("/", "image", true, true);
    ...
    loadPackage({"files": [{"filename": "/Place_your_games_Source_directory_containing_assets_here", "start": 0, "end": 0}, {"filename": "/System/Fonts/Asheville-Sans-14-Light.ttf", "start": 0, "end": 47708}, {"filename": "/System/Fonts/Origin_of_fonts.txt", "start": 47708, "end": 47945}, {"filename": "/System/Fonts/Roobert-10-Bold.ttf", "start": 47945, "end": 59033}, {"filename": "/card/card.png", "start": 59033, "end": 60009}, {"filename": "/image/GhostTiles-table-16-16.png", "start": 60009, "end": 60913}, {"filename": "/image/baseGhost.png", "start": 60913, "end": 61156}, {"filename": "/level.txt", "start": 61156, "end": 61545}, {"filename": "/pdex.dylib", "start": 61545, "end": 114697}, {"filename": "/pdxinfo", "start": 114697, "end": 114821}], "remote_package_size": 114821});

  })();

// end include: /tmp/tmpf78l1m16.js
// include: /tmp/tmpb8bfzrqd.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpb8bfzrqd.js
// include: /tmp/tmp40xberol.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp40xberol.js
...
var ASM_CONSTS = {
  644520: () => { var context; try { context = new AudioContext(); } catch (e) { context = new webkitAudioContext(); } return context.sampleRate; },  
 644652: ($0) => { _pd_api_file_init_emscripten_done = 0; FS.mkdir('/saveddata.' + UTF8ToString($0)); FS.mount(IDBFS, {}, '/saveddata.' + UTF8ToString($0)); FS.syncfs(true, function (err) { if (err) console.log(err); _pd_api_file_init_emscripten_done = 1; }); },  
 644897: () => { return _pd_api_file_init_emscripten_done },  
 644938: () => { return _pd_api_file_init_emscripten_done },  
 644979: () => { _pd_api_file_sync_emscripten_done = 0; FS.syncfs(false, function (err) { if (err) console.log("Error syncing files: " + err); _pd_api_file_sync_emscripten_done = 1; }); },  
 645148: () => { return _pd_api_file_sync_emscripten_done },  
 645189: () => { return _pd_api_file_sync_emscripten_done },  
 645230: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return reply.length === 1 ? reply.charCodeAt(0) : -1; },  
 645445: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 645592: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
