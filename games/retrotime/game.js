...
Module['FS_createPath']("/", "Licences", true, true);
Module['FS_createPath']("/", "Source1", true, true);
Module['FS_createPath']("/Source1", "graphics", true, true);
Module['FS_createPath']("/Source1/graphics", "blockstacker", true, true);
Module['FS_createPath']("/Source1/graphics", "breakout", true, true);
Module['FS_createPath']("/Source1/graphics", "fasterdave", true, true);
Module['FS_createPath']("/Source1/graphics", "frog", true, true);
Module['FS_createPath']("/Source1/graphics", "invaders", true, true);
Module['FS_createPath']("/Source1/graphics", "main", true, true);
Module['FS_createPath']("/Source1/graphics", "pang", true, true);
...
Module['FS_createPath']("/graphics", "blockstacker", true, true);
Module['FS_createPath']("/graphics", "breakout", true, true);
Module['FS_createPath']("/graphics", "fasterdave", true, true);
Module['FS_createPath']("/graphics", "frog", true, true);
Module['FS_createPath']("/graphics", "invaders", true, true);
Module['FS_createPath']("/graphics", "main", true, true);
Module['FS_createPath']("/graphics", "pang", true, true);
Module['FS_createPath']("/", "metadata", true, true);
Module['FS_createPath']("/", "music", true, true);
Module['FS_createPath']("/music", "blockstacker", true, true);
Module['FS_createPath']("/music", "breakout", true, true);
Module['FS_createPath']("/music", "fasterdave", true, true);
Module['FS_createPath']("/music", "frog", true, true);
Module['FS_createPath']("/music", "invaders", true, true);
Module['FS_createPath']("/music", "main", true, true);
Module['FS_createPath']("/music", "pang", true, true);
Module['FS_createPath']("/music", "ramit", true, true);
Module['FS_createPath']("/music", "snakey", true, true);
Module['FS_createPath']("/", "sound", true, true);
Module['FS_createPath']("/sound", "blockstacker", true, true);
Module['FS_createPath']("/sound", "breakout", true, true);
Module['FS_createPath']("/sound", "common", true, true);
Module['FS_createPath']("/sound", "frog", true, true);
Module['FS_createPath']("/sound", "invaders", true, true);
Module['FS_createPath']("/sound", "main", true, true);
Module['FS_createPath']("/sound", "pang", true, true);
Module['FS_createPath']("/sound", "ramit", true, true);
Module['FS_createPath']("/sound", "snakey", true, true);
...
// end include: /tmp/tmp7gkllbhc.js
// include: /tmp/tmpu6tleuf2.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpu6tleuf2.js
// include: /tmp/tmp3ge58inp.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp3ge58inp.js
...
var dynCall_iiiiiifii = makeInvalidEarlyAccess('dynCall_iiiiiifii');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['dynCall_iiiiiifii'] != 'undefined', 'missing Wasm export: dynCall_iiiiiifii');
  dynCall_iiiiiifii = dynCalls['iiiiiifii'] = createExportWrapper('dynCall_iiiiiifii', 9);
  ...
  dynCall_viifff = dynCalls['viifff'] = createExportWrapper('dynCall_viifff', 6);
