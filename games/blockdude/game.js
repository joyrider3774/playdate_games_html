...
Module['FS_createPath']("/Source1", "skins", true, true);
Module['FS_createPath']("/Source1/skins", "Default", true, true);
Module['FS_createPath']("/Source1/skins", "Flat", true, true);
Module['FS_createPath']("/Source1/skins", "Tech", true, true);
Module['FS_createPath']("/Source1/skins", "Ti-83", true, true);
Module['FS_createPath']("/", "System", true, true);
Module['FS_createPath']("/System", "Fonts", true, true);
Module['FS_createPath']("/", "fonts", true, true);
Module['FS_createPath']("/fonts", "Mini Sans 2X", true, true);
Module['FS_createPath']("/fonts", "Mini Sans", true, true);
Module['FS_createPath']("/fonts", "Nano Sans", true, true);
Module['FS_createPath']("/", "levels", true, true);
Module['FS_createPath']("/levels", "davy", true, true);
...
Module['FS_createPath']("/", "skins", true, true);
Module['FS_createPath']("/skins", "Default", true, true);
Module['FS_createPath']("/skins", "Flat", true, true);
Module['FS_createPath']("/skins", "Kenney", true, true);
Module['FS_createPath']("/skins", "Tech", true, true);
Module['FS_createPath']("/skins", "Ti-83", true, true);
...
// end include: /tmp/tmpi9mwlfs0.js
// include: /tmp/tmpagcuhifk.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpagcuhifk.js
// include: /tmp/tmpf3flbpbq.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpf3flbpbq.js
